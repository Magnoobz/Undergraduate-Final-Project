...
int main()
{
    ...
    initialize_particle_2((0.005+dx/2)*eax,(0.095+dx/2)*eax,(0.005+dy/2)*eay,(0.045+dy/2)*eay,(0.011+dx/2)*eax,(0.089+dx/2)*eax,(0.011+dy/2)*eay,(0.039+dy/2)*eay,135,60,0,"all_move",not_moving,xw,yw,h_temp);
    initialize_particle_2((0.011+dx/2)*eax,(0.089+dx/2)*eax,(0.011+dy/2)*eay,(0.039+dy/2)*eay,1,0,1,0,78,28,0,"all_move",not_moving,xw,yw,h_temp);
