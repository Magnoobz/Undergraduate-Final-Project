...
int main()
{
    ...
    initialize_particle_2((0.005+dx/2)*eax,(0.095+dx/2)*eax,(0.005+dy/2)*eay,(0.045+dy/2)*eay,(0.015+dx/2)*eax,(0.085+dx/2)*eax,(0.015+dy/2)*eay,(0.035+dy/2)*eay,72,32,0,"all_move",not_moving,xw,yw,h_temp);
    initialize_particle_2((0.015+dx/2)*eax,(0.085+dx/2)*eax,(0.015+dy/2)*eay,(0.035+dy/2)*eay,1,0,1,0,42,12,0,"all_move",not_moving,xw,yw,h_temp);
