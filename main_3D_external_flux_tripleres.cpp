...
int main()
{
    ...
    double dx3 = 0.0016666;
    double dy3 = 0.0016666;
    double dz3 = 0.0016666;
    ...
    string name3 = "output/3D External Flux/Multires/result 86/smaller/out_" + to_string(count) + ".csv";
