...
int main()
{
    ...
    initialize_particle_3D_2(0.03,0.04,y_bottom,y_top,z_back,z_front,12,12,12,0,0,3,3,3,3,not_moving,x_w,y_w,z_w,h_temp);
    initialize_particle_3D_2(0.04,0.05,y_bottom,y_top,z_back,z_front,10,10,10,0,0,3,3,3,3,not_moving,x_w,y_w,z_w,h_temp);
    initialize_particle_3D_2(0.05,x_right,y_bottom,y_top,z_back,z_front,40,8,8,3,0,3,3,3,3,not_moving,x_w,y_w,z_w,h_temp);
