...
int main()
{
    ...
    double dx2 = 0.00142857;
    double dy2 = 0.00142857;
    double dz2 = 0.00142857;
    ...
    string name1 = "output/3D External Flux/Multires/result 7/big/out_" + to_string(count) + ".csv";
    string name2 = "output/3D External Flux/Multires/result 7/small/out_" + to_string(count) + ".csv";
    ...
    ofstream output3;
    output3.open("output/3D External Flux/Multires/result 7/summary.csv");
