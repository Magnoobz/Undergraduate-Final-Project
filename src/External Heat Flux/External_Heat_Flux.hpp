...
void External_Heat_Flux(vector<double> q_x,
                        vector<double> q_y,
                        vector<double> hx,
                        vector<double> hy,
...
void Internal_Heat_flux(vector<double> Q,
                        vector<double> hx,
                        vector<double> hy,
                        vector<double> &heat_flux)
{
...
void Convection_Heating(vector<double> conv_x,
                        ...
                        vector<double> &heat_flux)
{
    ...
    for (int i = 0; i < no_particle; i++)
    {
        heat_flux[i] += (hx[i]*conv_y[i]  + hy[i]*conv_x[i])*T_conv[i];
    }
}
